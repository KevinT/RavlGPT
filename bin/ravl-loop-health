...
Usage:
    ravl-loop-health <loop-name> [--focus TEXT]

Examples:
    ravl-loop-health org_context
    ravl-loop-health strategy_coherence --focus "Check for API rate limiting"
    ravl-loop-health my_loop --focus "have a look why there's no data in the output"
...
parser = argparse.ArgumentParser(
    description='RAVL Loop Health Check - Analyze domain learning and patterns',
    formatter_class=argparse.RawDescriptionHelpFormatter,
    epilog="""
Examples:
  ravl-loop-health org_context
  ravl-loop-health my_loop --focus "Check for API rate limiting"
...
parser.add_argument('--focus', type=str, default=None,
                    help='Custom focus area for health analysis (e.g., "Check for API rate limiting")')
